...
class SOGetStaffMemberEngagementsTest extends SOClassTest {
    ...
    void testExecuteSuccess() throws Exception {
        ...
        when(dbb.getStaffMemberEngagements(sm1)).thenReturn(pl2);

        Response response = so.execute(sm1);

        verify(dbb, times(1)).getStaffMemberEngagements(sm1);
    ...
    void testExecuteError() throws Exception {
        ...
        doThrow(new SQLException()).when(dbb).getStaffMemberEngagements(sm1);
